        ...
        <>
          ...
          <View style={styles.headerCard}>
            ...
            <View style={styles.codeRow}>
              <Icon name="key-outline" size={16} color={colors.textMuted} />
              <Text style={styles.codeText}>{group.inviteCode}</Text>
              <TouchableOpacity onPress={handleShare}>
                <Icon name="share-outline" size={18} color={colors.primaryLight} />
              </TouchableOpacity>
            </View>
            ...
            leaderboard.map((entry: any, index: number) => {
              ...
              return (
                <View key={entry.userId} style={[styles.leaderRow, isMe && styles.leaderRowMe]}>
                  <Text style={styles.leaderRank}>{medal || `#${index + 1}`}</Text>
